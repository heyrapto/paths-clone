              ...
              <div className="footer_inner__hdEE8">
                ...
                <div className="footer_navigation__r67os">
                  <nav>
                    ...
                    <a className="s link" href="/careers">Careers</a>
                  ...
                  {/* Social Links */}
                  <ul className="footer_social__kg6c3">
                    <li><a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/PathRobotics" className="link s">Facebook</a></li>
                    <li><a target="_blank" rel="noopener noreferrer" href="https://twitter.com/pathrobotics" className="link s">Twitter</a></li>
                    <li><a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/pathrobotics/" className="link s">Instagram</a></li>
                    <li><a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/company/path-robotics/" className="link s">LinkedIn</a></li>
                    <li><a target="_blank" rel="noopener noreferrer" href="https://medium.com/@PathRobotics" className="link s">Medium</a></li>
                  </ul>
