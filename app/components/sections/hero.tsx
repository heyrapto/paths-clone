  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (scrollProgress <= catchUpProgress) {
        ...
        const syncProgress =
          (scrollProgress - catchUpProgress) / (1 - catchUpProgress);
        ...
        <section className="home_hero__vJLkN" id="hero" ref={heroRef}>
          ...
          <div className="home_heading__56sD2">
            ...
            <h1 className="h1 ol-5-col" id="header_2" ref={header2Ref}>
              Autonomous Trust Layer for Robotics
            </h1>
          </div>
          ...
          <p className="home_callout__haRsE s or-15-col">
            A global reputation infrastructure that gives every robot a secure
            digital identity, measurable reputation, and the ability to prove
            reliability, accountability, and skill in a decentralized economy.
          </p>
        </section>
      ) : (
